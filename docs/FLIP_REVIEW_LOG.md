...
| 65 | rafi_04_0c80978fdd | endothermic → **polymerization shrinkage** (PMMA exo) | provisional || 66 | rafi_04_ee907b2f81 | mesiobuccal-distopalatal → **distobuccal + mesiopalatal (ML↔DB)** ⚠️ CORRECTED earlier flip — Sturdevant + McDonald both say ML↔DB | Sturdevant/McDonald |
| 67 | rafi_06_217a412c96 | ML triangular + DB distal → **ML distal ridge + DB triangular ridge** | Sturdevant |
| 68 | rafi_04_ef383f064f | Horseshoe → **Palatal plate** (class I, only molars) | McCracken |
| 69 | rafi_04_49dea2ae5e | Lingual bar → **Double lingual bar** (lingual tori) | McCracken |
...
- rafi_04_7910f64b20 / rafi_04_eed6b4555b — A-P palatal strap for palatal torus (defensible; horseshoe not offered)
- rafi_04_a4df9d2590 — anterior strap most flexible among offered (narrow)
- rafi_04_3bdc2a1259 — horseshoe = highest elasticity (correct; confirms model's own claim)
- rafi_04_4f80d0c765 — spacer 2.0mm (within 2-3mm range)
- rafi_04_99a8210d30 — incisal papilla 8-10mm (classic)
- rafi_04_3fa313399d — maxillary connector 6mm from gingiva (model used mandibular 4mm)
- rafi_06_dd10cbf44d — "formed only of enamel" = NOT true (correct answer)
- rafi_06_e513662997 — Carabelli = mesiolingual cusp (correct)
- rafi_06_a43a263a9c — deciduous 2nd molar Carabelli (defensible; perm 1st not offered)
- rafi_06_0c7647425d — implant-tooth 1.5mm (within 1.5-2mm range)
- rafi_07_6daf082fb9 — protrusive: adjust MESIAL incline of mandibular cusp (correct; model backwards)
- rafi_07_d92c7916e8 — non-centric interferences → adjust cusps (correct)
- rafi_07_e6f9495367 — horseshoe for class II + torus (correct)
- rafi_07_6bcaad96d4 — cast partial for 53yo with treatable periodontitis (correct)
- rafi_07_c4b4aa0983 — autopolymerizing acrylic for chairside reline (correct)
- rafi_07_8bcad1319d — Akers → gingival recession (model agrees)
- rafi_07_70c7ceb364 — opposing amalgam wears off (model agrees)
- rafi_08_dfe697c6dd — enamel rods ⊥ outer surface (correct)
- rafi_08_b99095afe9 — composite matrix BISGMA (model agrees)
- rafi_08_bbc8721cd6 — alginate immersion ≤10 min (correct)
- rafi_08_e4e1828e1d — alginate left out = syneresis (correct)
- rafi_08_22acdb14d1 — wax bite registration for RPD (defensible)
- rafi_08_35ded3fb5c — smoking = (relative) contraindication (correct)
- rafi_08_23c43d1eac — radiotherapy = absolute contraindication (defensible)
- rafi_08_f77dcd4d5c — IOPAR best INTRAORAL film (model misread "initial")
- rafi_08_f11b9f70c5 — 47°C / 1min bone necrosis (classic)
- rafi_08_12b441c317 — pregnancy NOT relative (absolute → answer correct)
- rafi_08_6acc88ee56 — 3-5° per-wall taper (equivalent to 6° total)
...
- ab2_d30e554a9d — lip tumor options are all minor-SALIVARY-GLAND tumors → mucoepidermoid = most common MSG malignancy (model said SCC — not offered; question scope is MSG)
- ab2_b2a5ed6d81 — pyogenic granuloma recurrence: passage 16-19%; marked 15% = closest offered (keep)
- ab2_776a5e5fe8 — HIV + lateral tongue white lesion = hairy leukoplakia → benign, reassure (keep)
- ab2_2a7d47dffd — next-day numbness after UL6 deep caries = GP-foramen injection (classic prolonged palatal anesthesia complication; model misread)
...
- ab2_c3800fd1b1 — Down syndrome patient deemed CAPABLE → patient's own consent (not offered; father kept as family proxy — broken-ish)
...
- ab2_a5e8b1c050 — dentin 78%: majority INORGANIC (mineral ~70%; 78 figure off but inorganic = correct)
